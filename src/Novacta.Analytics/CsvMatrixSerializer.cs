...
namespace Novacta.Analytics
{
    ...
    public static class CsvMatrixSerializer
    {
            ...
            TextReader reader)
        {
            ...
            bool hasColumnNames = !(line is null);
        ...
        /// In its first line, the document contains information about the matrix number of 
        /// rows and columns, and optionally about the matrix name.
        /// The second line contains the optional column names.
        /// Additional lines contain information about the matrix rows.
        /// For a given row, the individual name is optional and is signaled by a non null string
        /// in the first token; subsequent tokens are interpreted as string
        /// representations of matrix entries.
        /// </para>
        /// <para>
        ...
        /// <example>
        /// <para>
        /// In the following example, the content of a well formed CSV document is 
        /// deserialized to create a matrix instance.
        /// In its first line, the document contains information about the matrix number of 
        /// rows and columns, and optionally about the matrix name.
        /// The second line contains the optional column names.
