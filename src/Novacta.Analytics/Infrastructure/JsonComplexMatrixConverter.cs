...
{
    /// <summary>
    /// Converts a <see cref="ComplexMatrix"/> or value to or from JSON.
    /// </summary>
    class JsonComplexMatrixConverter : JsonConverter<ComplexMatrix>
    {
        ///<inheritdoc/>
        public override ComplexMatrix Read(
            ...
            JsonSerializerOptions options)
        {
            ...
            ComplexMatrix matrix = new(matrixImplementor);
            ...
            JsonSerializerOptions options)
        {
            ...
            JsonSerializer.Serialize<MatrixImplementor<Complex>>(
                writer,
                value.implementor,
                options);
