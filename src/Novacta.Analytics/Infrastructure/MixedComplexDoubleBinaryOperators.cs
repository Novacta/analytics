...
namespace Novacta.Analytics.Infrastructure
{
    ...
    /// <see cref="Complex"/> type-based left operands and
    /// <see cref="double"/> type-based right operands.
    /// </summary>
    internal class MixedComplexDoubleBinaryOperators
    {
        #region Matrix
        ...
        {
            if (1 == left.Count)
                return DoubleMatrixOperators.Scalar_Dense_Multiply(right, left[0]);

            if (1 == right.Count)
                return ComplexMatrixOperators.Scalar_Dense_Multiply(left, right[0]);
            ...
            Complex[] rightArray = ImplementationServices.ToComplexArray(right.Storage);
        ...
        {
            if (1 == left.Count)
                return DoubleMatrixOperators.Scalar_Sparse_Multiply(right, left[0]);
            ...
            MatrixImplementor<double> right)
        {
            ...
            if (1 == right.Count)
                return ComplexMatrixOperators.Scalar_Sparse_Multiply(left, right[0]);
            ...
            var rightDense =
                (DenseComplexMatrixImplementor)
                    (DenseDoubleMatrixImplementor)right;
        ...
        {
            if (1 == left.Count)
                return DoubleMatrixOperators.Scalar_Dense_Sum(right, left[0]);

            if (1 == right.Count)
                return ComplexMatrixOperators.Scalar_Dense_Sum(left, right[0]);
        ...
        {
            if (1 == left.Count)
                return DoubleMatrixOperators.Scalar_Sparse_Sum(right, left[0]);
            ...
            MatrixImplementor<double> right)
        {
            ...
            if (1 == right.Count)
                return ComplexMatrixOperators.Scalar_Sparse_Sum(left, right[0]);
        ...
        {
            if (1 == left.Count)
                return DoubleMatrixOperators.Scalar_Dense_LeftSubtract(right, left[0]);

            if (1 == right.Count)
                return ComplexMatrixOperators.Scalar_Dense_RightSubtract(left, right[0]);
        ...
        {
            if (1 == left.Count)
                return DoubleMatrixOperators.Scalar_Sparse_LeftSubtract(right, left[0]);
            ...
            MatrixImplementor<double> right)
        {
            ...
            if (1 == right.Count)
                return ComplexMatrixOperators.Scalar_Sparse_RightSubtract(left, right[0]);
        ...
        {
            if (1 == left.Count)
                return DoubleMatrixOperators.Scalar_Dense_LeftDivide(right, left[0]);

            if (1 == right.Count)
                return ComplexMatrixOperators.Scalar_Dense_RightDivide(left, right[0]);
            ...
            if (rightNumberOfRows == numberOfColumns) // R is square
            {
                ...
                else  // Not UpperTriangular
                {
                    ...
                    else  // Not LowerTriangular nor UpperTriangular 
                    {
                        if (right.IsSymmetric) // Try a Cholesky decomposition
                        {
                            ...
                            // We do not need to clone right, even if DPOSV overwrites it,
                            // since rightArray is a Complex[] equivalent of right.Storage
                ...
                if (false == isSpecializedAlgorithmSuccessfull)
                {
                    ...
                    var transposedRightFactorsArray =
                        ImplementationServices.ToComplexArray(right.Storage);
