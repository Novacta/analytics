...
namespace Novacta.Analytics.Tests.TestableItems.Addition
{
    ...
    class TestableMatrixMatrixAddition<TExpected> :
        TestableMatrixMatrixOperation<TExpected>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestableMatrixMatrixAddition{TExpected}"/> class.
        /// </summary>
        /// <param name="expected">The expected result or exception.</param>
        /// <param name="left">The left operand.</param>
        /// <param name="right">The right operand.</param>
        public TestableMatrixMatrixAddition(
            TExpected expected,
