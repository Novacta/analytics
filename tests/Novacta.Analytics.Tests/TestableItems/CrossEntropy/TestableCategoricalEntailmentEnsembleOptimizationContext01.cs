...
namespace Novacta.Analytics.Tests.TestableItems.CrossEntropy
{
    ...
    /// a Cross-Entropy context to update an existing ensemble
    /// by adding the best additional categorical entailment 
    /// (in the sense of classification accuracy maximization),
    /// aimed to explain the specified 
    /// items in a feature set.
    /// </summary>
    class TestableCategoricalEntailmentEnsembleOptimizationContext01 :
        TestableCategoricalEntailmentEnsembleOptimizationContext
    {
        ...
        private const int numberOfCategoricalEntailments = 1;
        ...
        public static double Performance(DoubleMatrix x)
        {
            ...
            var entailments = new List<CategoricalEntailment>(InitialEntailments);
        ...
        /// <see cref="TestableCategoricalEntailmentEnsembleOptimizationContext01" /> class.
        /// </summary>
        ...
        /// <see cref="TestableCategoricalEntailmentEnsembleOptimizationContext01"/> class.</returns>
        public static TestableCategoricalEntailmentEnsembleOptimizationContext01 Get()
        {
            return new TestableCategoricalEntailmentEnsembleOptimizationContext01();
        }
    }
}