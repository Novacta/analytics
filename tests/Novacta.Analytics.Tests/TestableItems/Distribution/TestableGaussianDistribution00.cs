...
{
    /// <summary>
    /// Provides methods to test implementations of the Gaussian
    /// distribution having mean <c>-1.246312</c> and standard deviation
    /// <c>2.876598</c>.
    /// </summary>
    class TestableGaussianDistribution00 : TestableProbabilityDistribution
    {
        /// <summary>
        /// Initializes a new instance of the 
        /// <see cref="TestableGaussianDistribution00" /> class.
        /// </summary>
        TestableGaussianDistribution00() : base(
            probabilityDistribution:
                new GaussianDistribution(mu: -1.246312, sigma: 2.876598),
            mean: -1.246312,
        ...
        /// <see cref="TestableGaussianDistribution00"/> class.</returns>
        public static TestableGaussianDistribution00 Get()
        {
            return new TestableGaussianDistribution00();
        }
    }
}
