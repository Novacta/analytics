...
namespace Novacta.Analytics.Tests.TestableItems.Division
{
    ...
    class RightIsRectangularLessRowsThanColsComplexMatrixComplexMatrixDivision :
        TestableComplexMatrixComplexMatrixDivision<ComplexMatrixState>
    {
        ...
        /// <summary>
        /// Gets an instance of the <see cref="RightIsRectangularLessRowsThanColsComplexMatrixComplexMatrixDivision"/> class.
        /// </summary>
        /// <returns>An instance of the 
        /// <see cref="RightIsRectangularLessRowsThanColsComplexMatrixComplexMatrixDivision"/> class.</returns>
        public static RightIsRectangularLessRowsThanColsComplexMatrixComplexMatrixDivision Get()
        {
            return new RightIsRectangularLessRowsThanColsComplexMatrixComplexMatrixDivision();
        }
    }
}
