...
namespace Novacta.Analytics.Tests.TestableItems.Division
{
    ...
    ///	</summary>
    class LeftIsScalarDoubleMatrixComplexMatrixDivision :
        TestableDoubleMatrixComplexMatrixDivision<ComplexMatrixState>
    {
        ...
        LeftIsScalarDoubleMatrixComplexMatrixDivision() :
            base(
        ...
        /// <summary>
        /// Gets an instance of the <see cref="LeftIsScalarDoubleMatrixComplexMatrixDivision"/> class.
        /// </summary>
        /// <returns>An instance of the 
        /// <see cref="LeftIsScalarDoubleMatrixComplexMatrixDivision"/> class.</returns>
        public static LeftIsScalarDoubleMatrixComplexMatrixDivision Get()
        {
            return new LeftIsScalarDoubleMatrixComplexMatrixDivision();
        }
    }
