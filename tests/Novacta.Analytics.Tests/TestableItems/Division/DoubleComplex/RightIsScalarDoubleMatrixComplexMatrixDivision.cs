...
namespace Novacta.Analytics.Tests.TestableItems.Division
{
    ...
    ///	</summary>
    class RightIsScalarDoubleMatrixComplexMatrixDivision :
        TestableDoubleMatrixComplexMatrixDivision<ComplexMatrixState>
    {
        ...
        /// <summary>
        /// Gets an instance of the <see cref="RightIsScalarDoubleMatrixComplexMatrixDivision"/> class.
        /// </summary>
        /// <returns>An instance of the 
        /// <see cref="RightIsScalarDoubleMatrixComplexMatrixDivision"/> class.</returns>
        public static RightIsScalarDoubleMatrixComplexMatrixDivision Get()
        {
            return new RightIsScalarDoubleMatrixComplexMatrixDivision();
        }
    }
}
