...
namespace Novacta.Analytics.Tests.TestableItems.Division
{
    ...
    class RightIsHessenbergDoubleMatrixDoubleMatrixDivision :
        TestableDoubleMatrixDoubleMatrixDivision<DoubleMatrixState>
    {
        ...
        /// <summary>
        /// Gets an instance of the <see cref="RightIsHessenbergDoubleMatrixDoubleMatrixDivision"/> class.
        /// </summary>
        /// <returns>An instance of the 
        /// <see cref="RightIsHessenbergDoubleMatrixDoubleMatrixDivision"/> class.</returns>
        public static RightIsHessenbergDoubleMatrixDoubleMatrixDivision Get()
        {
            return new RightIsHessenbergDoubleMatrixDoubleMatrixDivision();
        }
    }
}
