...
namespace Novacta.Analytics.Tests.TestableItems.Division
{
    ...
    class RightIsLowerTriangularMatrixMatrixDivision :
        TestableMatrixMatrixDivision<DoubleMatrixState>
    {
        RightIsLowerTriangularMatrixMatrixDivision() :
            base(
        ...
        /// <summary>
        /// Gets an instance of the <see cref="RightIsLowerTriangularMatrixMatrixDivision"/> class.
        /// </summary>
        /// <returns>An instance of the 
        /// <see cref="RightIsLowerTriangularMatrixMatrixDivision"/> class.</returns>
        public static RightIsLowerTriangularMatrixMatrixDivision Get()
        {
            return new RightIsLowerTriangularMatrixMatrixDivision();
        }
    }
}
