...
namespace Novacta.Analytics.Tests.TestableItems.ElementWiseMultiplication
{
    ...
    class RightWrongColsMatrixMatrixElementWiseMultiplication :
        TestableMatrixMatrixElementWiseMultiplication<ArgumentException>
    {
        RightWrongColsMatrixMatrixElementWiseMultiplication() :
            base(
        ...
        /// <summary>
        /// Gets an instance of the <see cref="RightWrongColsMatrixMatrixElementWiseMultiplication"/> class.
        /// </summary>
        /// <returns>An instance of the 
        /// <see cref="RightWrongColsMatrixMatrixElementWiseMultiplication"/> class.</returns>
        public static RightWrongColsMatrixMatrixElementWiseMultiplication Get()
        {
            return new RightWrongColsMatrixMatrixElementWiseMultiplication();
        }
    }
}
