...
namespace Novacta.Analytics.Tests.TestableItems.Kurtosis
{
    ...
    /// </summary>
    class OnRowsAdjustedKurtosis02 :
        AlongDimensionKurtosis<DoubleMatrixState>
    {
        protected OnRowsAdjustedKurtosis02() :
                base(
        ...
        /// <summary>
        /// Gets an instance of the <see cref="OnRowsAdjustedKurtosis02"/> class.
        /// </summary>
        /// <returns>An instance of the 
        /// <see cref="OnRowsAdjustedKurtosis02"/> class.</returns>
        public static OnRowsAdjustedKurtosis02 Get()
        {
            return new OnRowsAdjustedKurtosis02();
        }
    }
}