...
{
    class TestableClassicalMultidimensionalScaling03
        : TestableClassicalMultidimensionalScaling<TestableDoubleMatrix>
    {
        ...
        static TestableClassicalMultidimensionalScaling03()
        {
        ...
        TestableClassicalMultidimensionalScaling03()
            : base(
                  proximities,
        ...
        /// <see cref="TestableClassicalMultidimensionalScaling03"/> class.
        /// </summary>
        /// <returns>An instance of the 
        /// <see cref="TestableClassicalMultidimensionalScaling03"/> class.</returns>
        public static TestableClassicalMultidimensionalScaling03 Get()
        {
            return new TestableClassicalMultidimensionalScaling03();
        }
    }
}