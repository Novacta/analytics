...
{
    class TestableNonMetricMultidimensionalScaling04
        : TestableNonMetricMultidimensionalScaling<TestableDoubleMatrix>
    {
        ...
        static TestableNonMetricMultidimensionalScaling04()
        {
        ...
        TestableNonMetricMultidimensionalScaling04()
            : base(
                  dissimilarities,
        ...
        /// <see cref="TestableNonMetricMultidimensionalScaling04"/> class.
        /// </summary>
        /// <returns>An instance of the 
        /// <see cref="TestableNonMetricMultidimensionalScaling04"/> class.</returns>
        public static TestableNonMetricMultidimensionalScaling04 Get()
        {
            return new TestableNonMetricMultidimensionalScaling04();
        }
    }
}