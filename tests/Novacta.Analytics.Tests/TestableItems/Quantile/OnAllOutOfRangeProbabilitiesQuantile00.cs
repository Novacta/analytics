...
namespace Novacta.Analytics.Tests.TestableItems.Quantile
{
    ...
    /// a negative entry.
    /// </summary>
    class OnAllOutOfRangeProbabilitiesQuantile00 :
        OnAllQuantile<ArgumentException>
    {
        protected OnAllOutOfRangeProbabilitiesQuantile00() :
            base(
        ...
        /// <summary>
        /// Gets an instance of the <see cref="OnAllOutOfRangeProbabilitiesQuantile00"/> class.
        /// </summary>
        /// <returns>An instance of the 
        /// <see cref="OnAllOutOfRangeProbabilitiesQuantile00"/> class.</returns>
        public static OnAllOutOfRangeProbabilitiesQuantile00 Get()
        {
            return new OnAllOutOfRangeProbabilitiesQuantile00();
        }
    }
}
