...
namespace Novacta.Analytics.Tests.TestableItems.Skewness
{
    ...
    /// </summary>
    class OnColumnsUnadjustableSkewness : AlongDimensionSkewness<ArgumentException>
    {
        ...
        /// <summary>
        /// Gets an instance of the <see cref="OnColumnsUnadjustableSkewness"/> class.
        /// </summary>
        /// <returns>An instance of the 
        /// <see cref="OnColumnsUnadjustableSkewness"/> class.</returns>
        public static OnColumnsUnadjustableSkewness Get()
        {
            return new OnColumnsUnadjustableSkewness();
        }
    }
}