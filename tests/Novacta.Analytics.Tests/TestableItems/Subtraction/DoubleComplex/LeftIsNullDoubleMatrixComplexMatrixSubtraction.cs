...
namespace Novacta.Analytics.Tests.TestableItems.Subtraction
{
    ...
    class LeftIsNullDoubleMatrixComplexMatrixSubtraction :
        TestableDoubleMatrixComplexMatrixSubtraction<ArgumentNullException>
    {
        LeftIsNullDoubleMatrixComplexMatrixSubtraction() :
            base(
        ...
        public static LeftIsNullDoubleMatrixComplexMatrixSubtraction Get()
        {
            return new LeftIsNullDoubleMatrixComplexMatrixSubtraction();
        }
    }
}
