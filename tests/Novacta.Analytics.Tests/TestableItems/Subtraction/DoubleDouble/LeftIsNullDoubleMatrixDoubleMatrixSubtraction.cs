...
namespace Novacta.Analytics.Tests.TestableItems.Subtraction
{
    ...
    class LeftIsNullMatrixMatrixSubtraction :
        TestableDoubleMatrixDoubleMatrixSubtraction<ArgumentNullException>
    {
        LeftIsNullMatrixMatrixSubtraction() :
            base(
        ...
        public static LeftIsNullMatrixMatrixSubtraction Get()
        {
            return new LeftIsNullMatrixMatrixSubtraction();
        }
    }
}
