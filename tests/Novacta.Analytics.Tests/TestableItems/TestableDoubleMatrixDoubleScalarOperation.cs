...
namespace Novacta.Analytics.Tests.TestableItems
{
    ...
    /// double scalar.
    /// </summary>
    class TestableDoubleMatrixDoubleScalarOperation<TExpected> :
        TestableBinaryOperation<TestableDoubleMatrix, double, TExpected>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestableDoubleMatrixDoubleScalarOperation" /> class.
        /// </summary>
        ...
        protected TestableDoubleMatrixDoubleScalarOperation(
                    TExpected expected,
