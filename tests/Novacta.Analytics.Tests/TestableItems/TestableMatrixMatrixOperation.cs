...
namespace Novacta.Analytics.Tests.TestableItems
{
    ...
    /// </summary>
    class TestableMatrixMatrixOperation<TExpected> :
        TestableBinaryOperation<TestableDoubleMatrix, TestableDoubleMatrix, TExpected>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestableMatrixMatrixOperation" /> class.
        /// </summary>
        ...
        protected TestableMatrixMatrixOperation(
                    TExpected expected,
