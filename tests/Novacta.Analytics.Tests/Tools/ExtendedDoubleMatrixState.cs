...
{
    /// <summary>
    /// Represents the state of a <see cref="DoubleMatrix"/> and 
    /// provides extended information about the patterns 
    /// observable in the matrix and the row and 
    /// column nomenclatures.
    /// </summary>
    class ExtendedDoubleMatrixState : DoubleMatrixState
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtendedDoubleMatrixState" /> class.
        /// </summary>
        ...
        public ExtendedDoubleMatrixState(
